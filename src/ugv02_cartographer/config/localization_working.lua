...
TRAJECTORY_BUILDER_2D.motion_filter.max_distance_meters = 0.020
TRAJECTORY_BUILDER_2D.motion_filter.max_time_seconds = 0.1
...
POSE_GRAPH.optimize_every_n_nodes = 1 --fits every n submaps with the orignal map
...
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.occupied_space_weight = 60.0 -- Increase for tighter match to the map
...
--TRAJECTORY_BUILDER_2D.ceres_scan_matcher.ceres_solver_options.max_num_iterations = 1 --default 10 -- Increase for better optimization
TRAJECTORY_BUILDER_2D.adaptive_voxel_filter.max_length = 1
--TRAJECTORY_BUILDER_2D.voxel_filter_size = 0.035 --default 0.025
...
POSE_GRAPH.constraint_builder.sampling_ratio = 0.012 --Defult 0.3 map building constraints's ration
-- POSE_GRAPH.global_sampling_ratio = 0.001 --default 0.003

POSE_GRAPH.constraint_builder.max_constraint_distance = 1
POSE_GRAPH.global_constraint_search_after_n_seconds = 200.0
return options
